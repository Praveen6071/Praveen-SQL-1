...
USE neworderdirectory;

select count(t2.cus_gender)as NoOfCustomers,t2cus_gender from
...
where `order`.cus_id=2 and `order`.pricing_id =supplier_pricing_id and supplier_pricing.pro_id=product.pro_id;
